...
public class ComputerDatabaseStepDefs extends BaseUtil {
    private BaseUtil base;
    public ComputerDatabaseStepDefs(BaseUtil base){
        this.base = base;
    ...
    public void i_enter_information_as_follows(List<List<String>>data) throws InterruptedException {
